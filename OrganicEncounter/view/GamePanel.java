...
public class GamePanel  {
    ...
    private void buildUI(){                                   
        ...
        // --------------- ICON IMG LAYER
        ImageIcon healthIcon = new ImageIcon("OrganicEncounter/images/lp_transparent.png");
        ...
        ImageIcon repIcon = new ImageIcon("OrganicEncounter/images/rep_transparent.png");
        ...
        ImageIcon moneyIcon = new ImageIcon("OrganicEncounter/images/finance_transparent.png");
        ...
        circleLayer.setBounds(0,0, 500, 140);
        factorLayeredPane.add(circleLayer, Integer.valueOf(3));
        // test circleLayer.addCircle(250, 70, 10);
